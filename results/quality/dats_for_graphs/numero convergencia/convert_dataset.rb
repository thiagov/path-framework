...
files = ["#{visibility}-look1-num-convergencia.dat",
         "#{visibility}-look2-num-convergencia.dat",
         "#{visibility}-look3-num-convergencia.dat",
         "#{visibility}-look4-num-convergencia.dat"]
