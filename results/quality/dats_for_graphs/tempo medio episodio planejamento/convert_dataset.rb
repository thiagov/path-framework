...
files = ["#{visibility}-look1-tempo-medio-ep-busca.dat",
         "#{visibility}-look2-tempo-medio-ep-busca.dat",
         "#{visibility}-look3-tempo-medio-ep-busca.dat",
         "#{visibility}-look4-tempo-medio-ep-busca.dat"]
