...
files = ["#{visibility}-look1-tempo-total-busca.dat",
         "#{visibility}-look2-tempo-total-busca.dat",
         "#{visibility}-look3-tempo-total-busca.dat",
         "#{visibility}-look4-tempo-total-busca.dat"]
